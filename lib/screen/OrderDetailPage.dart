...
class _OrderDetailPage extends State<OrderDetailPage>
  ...
  Widget build(BuildContext context) {
    ...
    double fontSizeTitle = Constants.getPercentSize1(totalHeight, 1.9);
              ...
              children: [
                Row(
                  children: [
                    ...
                    getCustomText("#2CE5DW", primaryColor, 1, TextAlign.start,
                  ...
                  child: Row(
                    children: [
                      getCustomText(S.of(context).items + ": ", textColor, 1,
                          TextAlign.start, FontWeight.w500, fontSizeTitle),
                      getCustomText(myOrderList.length.toString(), primaryColor,
                ...
                Row(
                  children: [
                    getCustomText(S.of(context).toatalamount, primaryColor, 1,
                        TextAlign.start, FontWeight.bold, fontSizeLarge),
                    new Spacer(),
                    getCustomText("\$24.20", primaryColor, 1, TextAlign.start,
